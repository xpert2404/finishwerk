      ...
      <div className="mx-auto max-w-3xl space-y-8">
        <div className="space-y-4">
          ...
          <p className="max-w-2xl text-lg text-[var(--muted-strong)]">
            Privacy-first umgesetzt. Die Inhalte unten sind als belastbare
            Struktur vorbereitet und vor dem Livegang mit den finalen
            Unternehmensdaten zu vervollständigen.
          </p>
        </div>
